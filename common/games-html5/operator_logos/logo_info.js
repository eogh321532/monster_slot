...
UHTPatch({
	...
	apply:function()
	{
		...
		var gameSymbols = ["vs25luckwildpb","vs25luckwildpb_cv101"];
		if (gameSymbols.indexOf(window["UHT_GAME_CONFIG"]["GAME_SYMBOL"]) == -1 || window["UHT_CONFIG"]["LANGUAGE"] != "en")
			return;
			...
			Paytable_mobile.prototype.InitMobile = function()
			{
				...
				if (labelBlueprint != null)
				{
					...
					if (labelParent != null)
					{
						...
						var label = newObj.GetComponent(UILabel);
						label.width = 1000;
						label.transform.localPosition(0, -375, 0)
						label.maxLines = 1;
						label.fontSize = 25;
						label.text = "Collection is only visual and has no effect on the rate of triggering the features.";
						label.Start();
				...
				if (labelBlueprint != null)
				{
					...
					if (labelParent != null)
					{
						...
						var label = newObj.GetComponent(UILabel);
						label.width = 900;
						label.transform.localPosition(0, -1200, 0)
						label.height = 90;
						label.fontSize = 30;
						label.text = "Collection is only visual and has no effect on the rate of triggering the features.";
						label.Start();
					...
					"configs": [
					  {
						...
						`,
						"customText" : {
							en:`The max prize in this game is 10,000x, with a hitrate 1 in 1,000,000,000 and can be achieved on Free Spins With Extra Chips`,
							es:`El premio máx de este juego es de 10.000x con una tasa de aparición de 1 en 1.000.000.000 y se puede conseguir en Tiradas Gratis Con Fichas Extra`,
							pt:`O prêmio máximo neste jogo é de 10.000x, com uma taxa de acerto de 1 em 1.000.000.000 e pode ser alcançado no Rodadas Grátis Com Fichas Extra`,
						}
					  },
					  {
						"rtp": "95.01",
						...
						`,
						"customText" : {
							en:`The max prize in this game is 10,000x, with a hitrate 1 in 250,000,000 and can be achieved on Free Spins With Extra Chips`,
							es:`El premio máx de este juego es de 10.000x con una tasa de aparición de 1 en 250.000.000 y se puede conseguir en Tiradas Gratis Con Fichas Extra`,
							pt:`O prêmio máximo neste jogo é de 10.000x, com uma taxa de acerto de 1 em 250.000.000 e pode ser alcançado no Rodadas Grátis Com Fichas Extra`,
						}
					  },
					  {
						"rtp": "96.03",
						...
						`,
						"customText" : {
							en:`The max prize in this game is 10,000x, with a hitrate 1 in 333,333,333 and can be achieved on Free Spins With Extra Chips`,
							es:`El premio máx de este juego es de 10.000x con una tasa de aparición de 1 en 333.333.333 y se puede conseguir en Tiradas Gratis Con Fichas Extra`,
							pt:`O prêmio máximo neste jogo é de 10.000x, com uma taxa de acerto de 1 em 333.333.333 e pode ser alcançado no Rodadas Grátis Com Fichas Extra`,
						}
					  },
					]
				},
...
UHTPatch({
	...
	apply: function()
	{
		...
		{
			XStype = "generic_477_20250311";
			window["UHT_GAME_CONFIG_SRC"].jurisdictionRequirements += ",XS:generic_477_20250311";
		}
