...
<%
// 1) request 객체에서 동적으로 꺼내기
String referer         = request.getHeader("Referer");
String serverHostname  = request.getServerName();
long   serverSeconds   = System.currentTimeMillis() / 1000;
...
clientInfo.put("referer",        referer);
clientInfo.put("serverHostname", serverHostname);
clientInfo.put("serverSeconds",  serverSeconds);
clientInfo.put("userAgent",      userAgent);

// 3) JSON → Base64
ObjectMapper mapper = new ObjectMapper();
String json = mapper.writeValueAsString(clientInfo);
String sessionKeyBase64 = Base64.getEncoder().encodeToString(json.getBytes(StandardCharsets.UTF_8));

//
String url = scheme + "://" + serverHostname;
String auth = request.getParameter("auth");
String sessionKey = sessionKeyBase64;
String sessionKey1 = "fSjwJTsGW8G3UGEom14/9pl6sdSCGcfuek7VWY5w0/0lpFCyJ9aIdKeFZijmztqe/ZdsBFcFxvyqvq/9Dg7s/w\u003d\u003d";
String sessionKey2 = "Akwqg77Y7HwU6sposQt6ug\u003d\u003d";
String sessionKey3 = "\u003d";
    ...
    <head>
        ...
        <script>
            ...
            Loader.SetExtraInfo = function() {
                var mobile = UHT_UA_INFO.device.type == "mobile" || UHT_UA_INFO.device.type == "tablet";
                UHT_DEVICE_TYPE = {
                    MOBILE: mobile,
                    DESKTOP: !mobile
                };
            ...
            Loader.LoadGame = function() {
                ...
                var script = Loader.LoadScript(UHT_CONFIG.GAME_URL + "bootstrap.js" + "?key=" + "ac6dd", Loader.LoadGameCallback, function() {
        ...
        <script type="text/javascript" src="<%=url%>/gs2c/common/js/html5-script-external.js"></script>
        <script type="text/javascript">
            Html5GameManager.init({
                ...
                mobileCashierUrl: "",
                mobileLobbyUrl: "",
                gameConfig: '{"lobbyLaunched":false,"lobbyFilter":"forYou","lobbyVersion":"V3","minimode":"0","multiProductMiniLobby":true,"jurisdiction":"99","openHistoryInWindow":true,"RELOAD_JACKPOT":"/gs2c/jackpot/reload.do","styleName":"agst-tw","SETTINGS":"/gs2c/saveSettings.do","gameVerificationURL":"<%=url%>/gs2c/session/verify","environmentId":"140","openHistoryInTab":false,"replaySystemUrl":"<%=url%>","ingameLobbyApiURL":"<%=url%>/ClientAPI/minilobby/common/games","historyType":"internal","vendor":"T","currency":"KRW","lang":"ko","datapath":"<%=url%>/gs2c/common/games-html5/games/vs/vs20olympgate/","amountType":"COIN","LOGOUT":"/gs2c/logout.do","REGULATION":"<%=url%>/gs2c/regulation/process.do?symbol\u003dvs20olympgate","datapath_alternative":"<%=url%>/gs2c/common/games-html5/games/vs/vs20olympgate/","sessionKey":["<%=sessionKey1 %>","<%=sessionKey2%>","<%=sessionKey3%>", "<%=sessionKey %>", "bnVsbA==", "MA==", "MTAwMDAwMDA="],"showRealCash":"1","statisticsURL":"<%=url%>/gs2c/stats.do","accountType":"R","clock":"0","mgckey":"<%=auth%>","gameService":"<%=url%>/gs2c/ge/v4/gameService","brandRequirements":"COINS_V2,VAPP,RUM,XS_KB","RELOAD_BALANCE":"/gs2c/reloadBalance.do","currencyOriginal":"KRW","extend_events":"1","sessionTimeout":"30","CLOSE_GAME":"/gs2c/closeGame.do?symbol\u003dvs20olympgate","region":"Asia","HISTORY":"<%=url%>/gs2c/lastGameHistory.do?symbol\u003dvs20olympgate\u0026mgckey\u003d<%=auth%>","sessionKeyV2":["jGOT2oqF6Vweb+EMObafK+ToSjnQFwOOUuvN1Ytvx+Tex0Ki4HQ9vbuRN6UYlTkBoLFkmgtq5Fzb3zk8ZWkC5tZadpazuwhugsT97UK8oD02WK5JQ0u+wE55uE/T8x/HDZ6bk1+sf4onprtF/ahM6CbQ6Qvv7Mk2WXZpB59KYpY\u003d","ZWcXwr0DzpNAp8jYi5uQ2mIbX0yULO3NA70xPJam+Lyck027sPtfHViA2GtXS738zBJ9gEBpbHt0I+b4AciAgxpNRrfsOgPCJ6/ZBSWap3G9DX8Drg4eE/auBx2zk0AJ/h/gN/vc6MnJBim/J+d/9ItL3OehjATTveQO6hrzO+Q\u003d"]}',
                mgckey: "<%=auth%>",
                jurisdictionMsg: "",
                extendSessionUrl: "",
